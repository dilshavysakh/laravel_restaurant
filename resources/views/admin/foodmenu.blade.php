...
<html lang="en">
  ...
  <div class="container-scroller"> 
    ...
    <div class="container my-5">
        <h3 class=" text-danger">Create New FoodMenu</h3>
        ...
        <center><h3 class="my-5 text-danger" >Highlighted Foods</h3></center>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <td class=""><img style="border-radius: 0%; width:70px;height:auto;" src="/foodimage/{{$data->image}}"></td>
                <td class="text-danger"><a href="{{url('/deletemenu',$data->id)}}">Delete</a></td>
                <td class="text-danger"><a href="{{url('/updatemenu',$data->id)}}">Update</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
